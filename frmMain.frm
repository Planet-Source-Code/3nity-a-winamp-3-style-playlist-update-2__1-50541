...
Begin VB.Form frmMain 
   ...
   Caption         =   "Preview of 3nity SS ocx -  PLEASE VOTE, SO I'LL KNOW IF YOU LIKE IT AND CONTINIOUE TO CODE IT"
   ClientHeight    =   6645
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   10860
   ...
   Begin VB.CheckBox Check7 
      Caption         =   "Lock (not recomended - much slower and sometimes flickering)"
      Height          =   240
      Left            =   4275
      TabIndex        =   47
      Top             =   6300
   ...
   Begin ProjectStdSS.stdSS stdSS1 
      ...
      BackgroundPicture=   "frmMain.frx":0000
   End
   ...
   Begin VB.Label Label13 
      Caption         =   "Click on the PictureBox to change the specified color:"
      Height          =   465
      Left            =   8775
      TabIndex        =   42
      Top             =   300
...
Me.stdSS1.SetScroller stdSS1.GUI_SSOzadjeäirina, CHK3, CHK4, CHK2, stdSS1.GUI_SSGoräirina, stdSS1.GUI_SSGorViöina, stdSS1.GUI_SSDoläirina, stdSS1.GUI_SSDolViöina, stdSS1.GUI_SSDrsnikMiniViöina
...
If Check5.Value = 1 Then
    Me.stdSS1.CenterBackgroundPicture = True
Else
    Me.stdSS1.CenterBackgroundPicture = False
End If
...
If Check6.Value = 1 Then
    Me.stdSS1.StretchBackgroundPicture = True
Else
    Me.stdSS1.StretchBackgroundPicture = False
End If
...
If Check7.Value = 1 Then
    Me.stdSS1.LockBackgroundPicture = True
Else
    Me.stdSS1.LockBackgroundPicture = False
End If
...
Me.CD.DialogTitle = "Load Background Picture"
CD.Filter = "All Suported Types|*.bmp; *.jpg; *.jpeg; *.gif; *.ico; *.cur"
CD.FileName = ""
CD.ShowOpen

If CD.FileName <> "" Then
    Set stdSS1.BackgroundPicture = LoadPicture(CD.FileName)
End If

End Sub

Private Sub Command9_Click()
    Set stdSS1.BackgroundPicture = Nothing
...
Me.stdSS1.SetScroller stdSS1.GUI_SSOzadjeäirina, True, True, True, stdSS1.GUI_SSGoräirina, stdSS1.GUI_SSGorViöina, stdSS1.GUI_SSDoläirina, stdSS1.GUI_SSDolViöina, stdSS1.GUI_SSDrsnikMiniViöina
